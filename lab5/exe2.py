...
temp_sorted = sorted(temperaturi)
print(temp_sorted)

print('cea mai mica termperatura este:', min(temperaturi), 'Cea mai mare:', max(temperaturi), \
     'Penultima cea mai mare:', temp_sorted[-2], 'Penultima cea mai mica:', temp_sorted[1])
